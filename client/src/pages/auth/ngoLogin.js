              ...
              <div className="col-md-12 col-lg-12 mx-auto">
                ...
                <form className="form" onSubmit={this.onSubmit}>
                  <div className="form-label-group">
                    <input name="email" onChange={this.onChange} type="email" id="inputEmail" className="form-control" placeholder="Email address" required autofocus value={this.state.email}/>
                    <label for="inputEmail">Email address</label>
                  </div>

                  <div className="form-label-group">
                    <input name="password" onChange={this.onChange} type="password" id="inputPassword" className="form-control" placeholder="Password" required value={this.state.password}/>
